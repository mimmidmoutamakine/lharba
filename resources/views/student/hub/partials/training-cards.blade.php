<div class="mt-6 training-models-card-grid">
    @forelse($rows as $row)
        ...
        <article class="training-model-card hub-float-in">
            <div class="training-model-card-top">
                <div class="training-model-head">
                    <h3 class="training-model-title" title="{{ $displayTitle }}">{{ $displayTitle }}</h3>
                    <p class="training-model-subtitle" title="{{ $item->title }}">{{ $item->title }}</p>
                </div>

                <div class="training-model-metrics">
            ...
            <div class="training-model-card-body">
                ...
                <div class="training-model-meta-row">
            ...
            <div class="training-model-card-footer">
                <div class="training-model-section-chip">
                    {{ $item->section_type === 'lesen' ? 'القراءة' : ($item->section_type === 'sprachbausteine' ? 'اللغة' : ($item->section_type === 'hoeren' ? 'الاستماع' : 'الكتابة')) }}
                </div>
